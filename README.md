...
So I recreated the map with d3js, this time centered on the region the article is named for.  Along the way, I combined list of countries from the original map with the countries shown in the **Members and Potential Members** table.  I also updated the color scale to a qualitative 3-class paired scale from [http://colorbrewer2.org/](http://colorbrewer2.org/). 
